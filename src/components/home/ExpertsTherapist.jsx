      ...
      <main className="flex flex-wrap items-center justify-center">
        {experts.map((expert) => (
          <div key={expert.id} className="flex flex-col group overflow-hidden">
            <div
              className={`bg-[url('/images/profile-images/${
                "avater-" + expert.id
              }.jpg')] bg-cover bg-center h-96 w-screen md:w-full min-w-80 py-10 text-2xl group-hover:scale-110 duration-200`}
            >
              <div className=" flex items-end justify-center h-full gap-3 mt-20 group-hover:mt-0 duration-200">
